...
export default function SignInPage() {
  return (
    <div className="w-full flex flex-col">
      <h2 className="text-[32px] font-bold text-[#222] mb-1" style={{ fontFamily: 'Inter, sans-serif' }}>Welcome back 👋</h2>
      <p className="text-[#666] text-[15px] mb-8" style={{ fontFamily: 'Inter, sans-serif' }}>Sign in to continue using PlaceCloud.</p>
      ...
      <form className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-[13px] font-medium text-[#444]" style={{ fontFamily: 'Inter, sans-serif' }}>Password</label>
        ...
        <div className="flex justify-end mt-[-4px] mb-2">
          <Link href="/forgot-password" className="hover:opacity-80 transition-opacity" style={{ 
            color: '#222', 
        ...
        <button 
          className="text-white font-bold text-[15px] w-full py-4 rounded-[12px] hover:opacity-90 transition-opacity mt-2"
          style={{
      ...
      <p className="text-center text-[14px] text-[#666] mt-8" style={{ fontFamily: 'Inter, sans-serif' }}>
        Dont have an account yet? <Link href="/sign-up" className="text-[#222] font-bold underline underline-offset-4 decoration-[#E5E5E5] hover:decoration-[#222] transition-colors">Sign Up</Link>
      </p>
    </div>
  );
}
